...
pub type RB_UEP7_BUF_MOD_R = crate::BitReader<bool>;
#[doc = "Field `RB_UEP7_BUF_MOD` writer - buffer mode of USB endpoint 7"]
pub type RB_UEP7_BUF_MOD_W<'a> = crate::BitWriter<'a, u8, R8_UEP7_MOD_SPEC, bool, 0>;
...
pub type RB_UEP7_TX_EN_W<'a> = crate::BitWriter<'a, u8, R8_UEP7_MOD_SPEC, bool, 2>;
...
pub type RB_UEP7_RX_EN_W<'a> = crate::BitWriter<'a, u8, R8_UEP7_MOD_SPEC, bool, 3>;
impl R {
