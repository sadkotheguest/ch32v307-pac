...
pub type MASK_USB_ADDR_W<'a> = crate::FieldWriter<'a, u8, R8_USB_DEV_AD_SPEC, u8, u8, 7, 0>;
...
pub type RB_UDA_GP_BIT_W<'a> = crate::BitWriter<'a, u8, R8_USB_DEV_AD_SPEC, bool, 7>;
impl R {
