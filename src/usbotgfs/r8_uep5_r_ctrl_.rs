#[doc = "Register `R8_UEP5_R_CTRL_` reader"]
pub struct R(crate::R<R8_UEP5_R_CTRL__SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<R8_UEP5_R_CTRL__SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<R8_UEP5_R_CTRL__SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<R8_UEP5_R_CTRL__SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `R8_UEP5_R_CTRL_` writer"]
pub struct W(crate::W<R8_UEP5_R_CTRL__SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<R8_UEP5_R_CTRL__SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<R8_UEP5_R_CTRL__SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<R8_UEP5_R_CTRL__SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MASK_UEP_R_RES_W<'a> =
    crate::FieldWriter<'a, u8, R8_UEP5_R_CTRL__SPEC, u8, u8, 2, 0>;
...
pub type USBHD_UEP_R_TOG_W<'a> = crate::BitWriter<'a, u8, R8_UEP5_R_CTRL__SPEC, bool, 2>;
...
pub type USBHD_UEP_AUTO_TOG_W<'a> = crate::BitWriter<'a, u8, R8_UEP5_R_CTRL__SPEC, bool, 3>;
impl R {
...
#[doc = "endpoint 5 control\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [r8_uep5_r_ctrl_](index.html) module"]
pub struct R8_UEP5_R_CTRL__SPEC;
impl crate::RegisterSpec for R8_UEP5_R_CTRL__SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [r8_uep5_r_ctrl_::R](R) reader structure"]
impl crate::Readable for R8_UEP5_R_CTRL__SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [r8_uep5_r_ctrl_::W](W) writer structure"]
impl crate::Writable for R8_UEP5_R_CTRL__SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets R8_UEP5_R_CTRL_ to value 0"]
impl crate::Resettable for R8_UEP5_R_CTRL__SPEC {
    #[inline(always)]
