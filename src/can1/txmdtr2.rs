...
pub type TIME_W<'a> = crate::FieldWriter<'a, u32, TXMDTR2_SPEC, u16, u16, 16, 16>;
#[doc = "Field `TGT` reader - TGT"]
pub type TGT_R = crate::BitReader<bool>;
#[doc = "Field `TGT` writer - TGT"]
pub type TGT_W<'a> = crate::BitWriter<'a, u32, TXMDTR2_SPEC, bool, 8>;
#[doc = "Field `DLC` reader - DLC"]
pub type DLC_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DLC` writer - DLC"]
pub type DLC_W<'a> = crate::FieldWriter<'a, u32, TXMDTR2_SPEC, u8, u8, 4, 0>;
impl R {
    #[doc = "Bits 16:31 - TIME"]
    #[inline(always)]
