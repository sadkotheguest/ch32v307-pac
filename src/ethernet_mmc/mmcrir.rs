...
pub type RFCES_W<'a> = crate::BitWriter<'a, u32, MMCRIR_SPEC, bool, 5>;
...
pub type RFAES_W<'a> = crate::BitWriter<'a, u32, MMCRIR_SPEC, bool, 6>;
...
pub type RGUFS_W<'a> = crate::BitWriter<'a, u32, MMCRIR_SPEC, bool, 17>;
impl R {
