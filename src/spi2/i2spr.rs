...
pub type MCKOE_W<'a> = crate::BitWriter<'a, u32, I2SPR_SPEC, bool, 9>;
...
pub type ODD_W<'a> = crate::BitWriter<'a, u32, I2SPR_SPEC, bool, 8>;
...
pub type I2SDIV_W<'a> = crate::FieldWriter<'a, u32, I2SPR_SPEC, u8, u8, 8, 0>;
impl R {
