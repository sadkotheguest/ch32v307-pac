...
pub type EA_W<'a> = crate::FieldWriter<'a, u32, EP0R_SPEC, u8, u8, 4, 0>;
...
pub type STAT_TX_W<'a> = crate::FieldWriter<'a, u32, EP0R_SPEC, u8, u8, 2, 4>;
...
pub type DTOG_TX_W<'a> = crate::BitWriter<'a, u32, EP0R_SPEC, bool, 6>;
...
pub type SETUP_W<'a> = crate::BitWriter<'a, u32, EP0R_SPEC, bool, 11>;
...
pub type STAT_RX_W<'a> = crate::FieldWriter<'a, u32, EP0R_SPEC, u8, u8, 2, 12>;
...
pub type DTOG_RX_W<'a> = crate::BitWriter<'a, u32, EP0R_SPEC, bool, 14>;
...
pub type CTR_RX_W<'a> = crate::BitWriter<'a, u32, EP0R_SPEC, bool, 15>;
impl R {
