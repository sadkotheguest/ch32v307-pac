...
pub type CLKDIV_W<'a> = crate::FieldWriter<'a, u32, CLKCR_SPEC, u8, u8, 8, 0>;
#[doc = "Field `CLKEN` reader - Clock enable bit"]
pub type CLKEN_R = crate::BitReader<bool>;
#[doc = "Field `CLKEN` writer - Clock enable bit"]
pub type CLKEN_W<'a> = crate::BitWriter<'a, u32, CLKCR_SPEC, bool, 8>;
...
pub type PWRSAV_W<'a> = crate::BitWriter<'a, u32, CLKCR_SPEC, bool, 9>;
...
pub type BYPASS_W<'a> = crate::BitWriter<'a, u32, CLKCR_SPEC, bool, 10>;
...
pub type WIDBUS_W<'a> = crate::FieldWriter<'a, u32, CLKCR_SPEC, u8, u8, 2, 11>;
...
pub type NEGEDGE_W<'a> = crate::BitWriter<'a, u32, CLKCR_SPEC, bool, 13>;
...
pub type HWFC_EN_W<'a> = crate::BitWriter<'a, u32, CLKCR_SPEC, bool, 14>;
impl R {
