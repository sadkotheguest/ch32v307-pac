...
pub struct R(crate::R<PADDR10_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PADDR10_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PADDR10_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PADDR10_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PADDR10` writer"]
pub struct W(crate::W<PADDR10_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PADDR10_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PADDR10_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PADDR10_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PA_W<'a> = crate::FieldWriter<'a, u32, PADDR10_SPEC, u32, u32, 32, 0>;
impl R {
