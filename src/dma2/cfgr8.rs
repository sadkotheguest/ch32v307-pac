...
pub struct R(crate::R<CFGR8_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CFGR8_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CFGR8_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CFGR8_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CFGR8` writer"]
pub struct W(crate::W<CFGR8_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CFGR8_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CFGR8_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CFGR8_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type EN_W<'a> = crate::BitWriter<'a, u32, CFGR8_SPEC, bool, 0>;
#[doc = "Field `TCIE` reader - Transfer complete interrupt enable"]
pub type TCIE_R = crate::BitReader<bool>;
#[doc = "Field `TCIE` writer - Transfer complete interrupt enable"]
pub type TCIE_W<'a> = crate::BitWriter<'a, u32, CFGR8_SPEC, bool, 1>;
...
pub type HTIE_W<'a> = crate::BitWriter<'a, u32, CFGR8_SPEC, bool, 2>;
...
pub type PINC_W<'a> = crate::BitWriter<'a, u32, CFGR8_SPEC, bool, 6>;
...
pub type PL_W<'a> = crate::FieldWriter<'a, u32, CFGR8_SPEC, u8, u8, 2, 12>;
...
pub type MEM2MEM_W<'a> = crate::BitWriter<'a, u32, CFGR8_SPEC, bool, 14>;
impl R {
