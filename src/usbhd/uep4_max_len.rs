...
pub struct R(crate::R<UEP4_MAX_LEN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UEP4_MAX_LEN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UEP4_MAX_LEN_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UEP4_MAX_LEN_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UEP4_MAX_LEN` writer"]
pub struct W(crate::W<UEP4_MAX_LEN_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UEP4_MAX_LEN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UEP4_MAX_LEN_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UEP4_MAX_LEN_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type UEP4_MAX_LEN_W<'a> =
    crate::FieldWriter<'a, u16, UEP4_MAX_LEN_SPEC, u16, u16, 11, 0>;
impl R {
    #[doc = "Bits 0:10 - endpoint 4 max acceptable length"]
    #[inline(always)]
    pub fn uep4_max_len(&self) -> UEP4_MAX_LEN_R {
        UEP4_MAX_LEN_R::new((self.bits & 0x07ff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:10 - endpoint 4 max acceptable length"]
    #[inline(always)]
    pub fn uep4_max_len(&mut self) -> UEP4_MAX_LEN_W {
