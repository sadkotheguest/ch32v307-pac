...
pub type UEP6_TX_DMA_R = crate::FieldReader<u32, u32>;
#[doc = "Field `UEP6_TX_DMA` writer - endpoint 6 DMA buffer address"]
pub type UEP6_TX_DMA_W<'a> = crate::FieldWriter<'a, u32, UEP6_TX_DMA_SPEC, u32, u32, 17, 0>;
impl R {
    #[doc = "Bits 0:16 - endpoint 6 DMA buffer address"]
    #[inline(always)]
    pub fn uep6_tx_dma(&self) -> UEP6_TX_DMA_R {
        UEP6_TX_DMA_R::new((self.bits & 0x0001_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:16 - endpoint 6 DMA buffer address"]
    #[inline(always)]
    pub fn uep6_tx_dma(&mut self) -> UEP6_TX_DMA_W {
