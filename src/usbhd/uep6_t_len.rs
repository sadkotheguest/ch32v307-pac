...
pub type UEP6_T_LEN_R = crate::FieldReader<u16, u16>;
#[doc = "Field `UEP6_T_LEN` writer - endpoint 6 send the length"]
pub type UEP6_T_LEN_W<'a> = crate::FieldWriter<'a, u16, UEP6_T_LEN_SPEC, u16, u16, 11, 0>;
impl R {
    #[doc = "Bits 0:10 - endpoint 6 send the length"]
    #[inline(always)]
    pub fn uep6_t_len(&self) -> UEP6_T_LEN_R {
        UEP6_T_LEN_R::new((self.bits & 0x07ff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:10 - endpoint 6 send the length"]
