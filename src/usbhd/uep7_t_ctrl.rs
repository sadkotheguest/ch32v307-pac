...
pub struct R(crate::R<UEP7_T_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UEP7_T_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UEP7_T_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UEP7_T_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UEP7_T_CTRL` writer"]
pub struct W(crate::W<UEP7_T_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UEP7_T_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UEP7_T_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UEP7_T_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MASK_UEP_T_RES_W<'a> = crate::FieldWriter<'a, u16, UEP7_T_CTRL_SPEC, u8, u8, 2, 0>;
...
pub type MASK_UEP_T_TOG_W<'a> = crate::FieldWriter<'a, u16, UEP7_T_CTRL_SPEC, u8, u8, 2, 3>;
...
pub type BUEP_T_TOG_AUTO_W<'a> = crate::BitWriter<'a, u16, UEP7_T_CTRL_SPEC, bool, 5>;
impl R {
