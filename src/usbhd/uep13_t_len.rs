...
pub struct R(crate::R<UEP13_T_LEN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UEP13_T_LEN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UEP13_T_LEN_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UEP13_T_LEN_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UEP13_T_LEN` writer"]
pub struct W(crate::W<UEP13_T_LEN_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UEP13_T_LEN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UEP13_T_LEN_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UEP13_T_LEN_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `UEP13_T_LEN` reader - endpoint 13 send the length"]
pub type UEP13_T_LEN_R = crate::FieldReader<u16, u16>;
#[doc = "Field `UEP13_T_LEN` writer - endpoint 13 send the length"]
pub type UEP13_T_LEN_W<'a> = crate::FieldWriter<'a, u16, UEP13_T_LEN_SPEC, u16, u16, 11, 0>;
impl R {
    #[doc = "Bits 0:10 - endpoint 13 send the length"]
    #[inline(always)]
    pub fn uep13_t_len(&self) -> UEP13_T_LEN_R {
        UEP13_T_LEN_R::new((self.bits & 0x07ff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:10 - endpoint 13 send the length"]
    #[inline(always)]
    pub fn uep13_t_len(&mut self) -> UEP13_T_LEN_W {
