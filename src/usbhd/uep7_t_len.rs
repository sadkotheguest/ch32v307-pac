...
pub type UEP7_T_LEN_R = crate::FieldReader<u16, u16>;
#[doc = "Field `UEP7_T_LEN` writer - endpoint 7 send the length"]
pub type UEP7_T_LEN_W<'a> = crate::FieldWriter<'a, u16, UEP7_T_LEN_SPEC, u16, u16, 11, 0>;
impl R {
    #[doc = "Bits 0:10 - endpoint 7 send the length"]
    #[inline(always)]
    pub fn uep7_t_len(&self) -> UEP7_T_LEN_R {
        UEP7_T_LEN_R::new((self.bits & 0x07ff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:10 - endpoint 7 send the length"]
