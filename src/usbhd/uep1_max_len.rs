...
pub struct R(crate::R<UEP1_MAX_LEN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UEP1_MAX_LEN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UEP1_MAX_LEN_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UEP1_MAX_LEN_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UEP1_MAX_LEN` writer"]
pub struct W(crate::W<UEP1_MAX_LEN_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UEP1_MAX_LEN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UEP1_MAX_LEN_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UEP1_MAX_LEN_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `UEP1_MAX_LEN` reader - endpoint 1 max acceptable length"]
pub type UEP1_MAX_LEN_R = crate::FieldReader<u16, u16>;
#[doc = "Field `UEP1_MAX_LEN` writer - endpoint 1 max acceptable length"]
pub type UEP1_MAX_LEN_W<'a> =
    crate::FieldWriter<'a, u16, UEP1_MAX_LEN_SPEC, u16, u16, 11, 0>;
impl R {
    #[doc = "Bits 0:10 - endpoint 1 max acceptable length"]
    #[inline(always)]
    pub fn uep1_max_len(&self) -> UEP1_MAX_LEN_R {
        UEP1_MAX_LEN_R::new((self.bits & 0x07ff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:10 - endpoint 1 max acceptable length"]
    #[inline(always)]
    pub fn uep1_max_len(&mut self) -> UEP1_MAX_LEN_W {
