...
#[doc = "Field `UEP1_T_LEN` reader - endpoint 1 send the length"]
pub type UEP1_T_LEN_R = crate::FieldReader<u16, u16>;
#[doc = "Field `UEP1_T_LEN` writer - endpoint 1 send the length"]
pub type UEP1_T_LEN_W<'a> = crate::FieldWriter<'a, u16, UEP1_T_LEN_SPEC, u16, u16, 11, 0>;
impl R {
    #[doc = "Bits 0:10 - endpoint 1 send the length"]
    #[inline(always)]
    pub fn uep1_t_len(&self) -> UEP1_T_LEN_R {
        UEP1_T_LEN_R::new((self.bits & 0x07ff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:10 - endpoint 1 send the length"]
