...
#[doc = "Field `UEP4_T_LEN` reader - endpoint 0 send the length"]
pub type UEP4_T_LEN_R = crate::FieldReader<u16, u16>;
#[doc = "Field `UEP4_T_LEN` writer - endpoint 0 send the length"]
pub type UEP4_T_LEN_W<'a> = crate::FieldWriter<'a, u16, UEP4_T_LEN_SPEC, u16, u16, 11, 0>;
impl R {
    #[doc = "Bits 0:10 - endpoint 0 send the length"]
    #[inline(always)]
    pub fn uep4_t_len(&self) -> UEP4_T_LEN_R {
        UEP4_T_LEN_R::new((self.bits & 0x07ff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:10 - endpoint 0 send the length"]
    #[inline(always)]
    pub fn uep4_t_len(&mut self) -> UEP4_T_LEN_W {
