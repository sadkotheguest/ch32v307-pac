...
#[doc = "Field `UEP0_T_LEN` reader - endpoint 0 send the length"]
pub type UEP0_T_LEN_R = crate::FieldReader<u16, u16>;
#[doc = "Field `UEP0_T_LEN` writer - endpoint 0 send the length"]
pub type UEP0_T_LEN_W<'a> = crate::FieldWriter<'a, u16, UEP0_T_LEN_SPEC, u16, u16, 11, 0>;
impl R {
